...
export function buildServiceViewerState(booking) {
  ...
  if (booking.status === "completed") {
    return {
      ...
      label: "Terminee",
      tone: "success",
      helper: "Cette prestation est terminée.",
  ...
  if (booking.payment_status === "paid") {
    return {
      ...
      label: "Paye",
      tone: "success",
      helper: "Vous avez déjà regle ce service.",
      actionLabel: conversationId ? "Voir la discussion" : "Voir ma réservation",
  ...
  if (booking.status === "confirmed") {
    return {
      ...
      actionLabel: bookingId ? "Payer maintenant" : "Voir ma réservation",
  ...
  if (booking.status === "cancelled") {
    return {
      ...
      label: "Annulee",
      tone: "danger",
      helper: "Votre derniere demande sur ce service a été annulée.",
